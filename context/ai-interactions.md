...
7. **Merge** - Merge to claude
8. **Delete Branch** - Delete branch after merge
9. **Implemented** - Move spec file into the @context/features/implemented folder
...
**NEVER** checkout or make changes to **main** branch. Only work on feature branches and merge into **claude** branch.
...
- Never put your signature "Generated With Claude" or similar in the commit messages
