<script lang="ts">
	...
	import type { MediaStatus, WatchItemType, WatchItem } from '$lib/types/media';
	...
	let editingMetadataItem = $state<WatchItem | null>(null);
	...
	function saveMetadata(updates: Partial<WatchItem>) {
