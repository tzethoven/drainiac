...
<div class="container mx-auto max-w-4xl px-4 py-8">
	<header class="mb-8">
		<div class="mb-4 flex items-center justify-between">
			<h1 class="text-3xl font-bold text-gray-900">Reading List</h1>
...
{#if showPicker}
	...
	>
		...
		>
			<h2 class="mb-4 text-2xl font-bold text-gray-900">What should you read next?</h2>

			{#if pickerItems.length === 0}
				<p class="text-gray-600">No queued items! Add some reading items first.</p>
			{:else}
				<div class="space-y-4">
