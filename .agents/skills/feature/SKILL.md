---
name: feature
description: Manage current feature workflow - create, load, start, review, explain or complete
argument-hint: create|load|start|review|test|explain|complete
---
...
| Action | Description |
|--------|-------------|
| `create` | Create a new feature spec in `context/features/` |
